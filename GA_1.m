...
% In order to ensure that the GA does not find the optimal solution, the
% number of chromosolmes must be reduced from 5 to 2. THis means that the
% GA would only be able to represent numbers between 0 - 3. Since the
% optimal solution is 7 the GA would not be able to represent that integer
% value.
nind=5;    % Size of a chromosome population
...
ngener=30; % Number of generations
